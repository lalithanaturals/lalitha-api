...
migrate((app) => {
  const collection = new Collection({
    ...
    "id": "pbc_3057729835",
    "indexes": [
      "CREATE UNIQUE INDEX idx_audit_registers_branch_date ON audit_registers (branch, date)"
    ],
    "listRule": "@request.auth.id != \"\"",
    "name": "audit_registers",
    "system": false,
    "type": "base",
  ...
  const collection = app.findCollectionByNameOrId("pbc_3057729835");
